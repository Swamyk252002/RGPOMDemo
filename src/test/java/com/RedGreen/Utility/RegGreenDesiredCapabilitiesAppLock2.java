...
public class RegGreenDesiredCapabilitiesAppLock2  
{
	@BeforeTest
	public static AndroidDriver<AndroidElement> getAndroidDriver() throws Exception{
		...
		try{
	        ...
	        dc.setCapability("appPackage","com.koushikdutta.vysor");
	        dc.setCapability("appActivity", "com.koushikdutta.vysor.StartActivity");
	        Thread.sleep(5000);
