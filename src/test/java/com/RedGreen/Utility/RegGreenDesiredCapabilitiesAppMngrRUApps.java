...
public class RegGreenDesiredCapabilitiesAppMngrRUApps 
{
	...
	public static AndroidDriver<AndroidElement> getAndroidDriver() throws Exception{
		...
		try{ 
	        ...
	        String appPath1 = System.getProperty("user.dir") + "/ESFile.apk"; 
	        String appPath2 = System.getProperty("user.dir") + "/DUSpeed.apk"; 
	        String appPath3 = System.getProperty("user.dir") + "/AppLock.apk"; 
	        //String appPath4 = System.getProperty("user.dir") + "/RedGreenl1.apk"; 
